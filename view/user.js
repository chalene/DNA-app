  ...
  render() {
    ...
    if (true) {
      idInput = <View style={styles.orderInputContainer}>
          ...
          <TextInput type="TextInput" name="id_number" keyboardType="number-pad" style={styles.orderInput} ref="id" returnKeyType = {"next"} onSubmitEditing={(event) => {this._refFocus("address");}} />
        </View>
        ...
        <ScrollView  ref='scrollView' showsVerticalScrollIndicator={false}>
          ...
          <Form style={styles.orderContainer} ref="form">
            <View style={styles.orderInputContainer}>
              ...
              <TextInput defaultValue={data.username} type="TextInput" name="name" style={styles.orderInput} ref="username" returnKeyType = {"next"}  onSubmitEditing={(event) => {this._refFocus("gender");}} />
            </View>
            <View style={styles.orderInputContainer}>
              <Text style={styles.orderInputText}>性别：</Text>
              <TextInput defaultValue={data.username} type="TextInput" name="gender" style={styles.orderInput} ref="gender" returnKeyType = {"next"} onSubmitEditing={(event) => {this._refFocus("email");}} />
            </View>
            <View style={styles.orderInputContainer}>
              <Text style={styles.orderInputText}>邮箱：</Text>
              <TextInput defaultValue={data.email} type="TextInput" name="email" style={styles.orderInput} ref="email" returnKeyType = {"next"} onSubmitEditing={(event) => {this._refFocus("password");}} />
            </View>
            <View style={styles.orderInputContainer}>
              <Text style={styles.orderInputText}>新密码：</Text>
              <TextInput  type="TextInput"  password={true} name="password" style={styles.orderInput} ref="password" returnKeyType = {"next"} onSubmitEditing={(event) => {this._refFocus("id");}} />
            </View>
            {idInput}
            <View style={styles.orderInputContainer}>
              <Text style={styles.orderInputText}>地址：</Text>
              <TextInput defaultValue={data.address} type="TextInput" name="address" style={styles.orderInput} ref="address" returnKeyType = {"next"} onSubmitEditing={(event) => {this._refFocus("alipay");}} />
            </View>
            <View style={styles.orderInputContainer}>
              <Text style={styles.orderInputText}>银行卡帐户：</Text>
              <TextInput defaultValue={data.postcode} type="TextInput" name="alipay_number" style={styles.orderInput} ref="alipay" onSubmitEditing={(event) => {this._refFocus("branch");}} />
            </View>
            <View style={styles.orderInputContainer}>
              <Text style={styles.orderInputText}>银行卡开户行：</Text>
              <TextInput defaultValue={data.postcode} type="TextInput" name="alipay_branch" style={styles.orderInput} ref="branch" />
            </View>
          </Form>
          {idUpload}
        </ScrollView>
